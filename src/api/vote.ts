...
import { GameStateError, IGameState, Turn, gameState } from '../state/gameState';
...
router.post<{}, string>('/', async (req, res) => {
    if (req.method === 'POST') {
        ...
        try {
            ...
            let game: IGameState | null = await gameState.getGame(gameId);
            ...
            try {
                ...
                game = await gameState.getGame(gameId);
